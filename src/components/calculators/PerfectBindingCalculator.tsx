...
interface PerfectBindingCalculatorProps {
  product: Product;
  quantity: number;
...
export const PerfectBindingCalculator: React.FC<PerfectBindingCalculatorProps> = ({
  product,
  quantity,
  setQuantity,
  selectedOptions,
      ...
      children: (
        <div className="space-y-8">
          ...
          <InfoCard 
            ...
            content={[
              "옆면을 풀로 붙여 묶는 방식입니다.",
              "두꺼운 보고서, 제안서, 단행본에 가장 적합합니다.",
              "페이지 수가 많을수록 무선제본의 완성도가 높아집니다."
            ]}
          />
        </div>
      )
